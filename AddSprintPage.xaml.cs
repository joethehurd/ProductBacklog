...
public partial class AddSprintPage : ContentPage
{
    ...
    private async void SaveSprintButton_Clicked(object sender, EventArgs e)
    {
        ...
        // add Sprint
        DataAccessService.AddSprint(new Guid(), SprintNameEntry.Text, SprintStartDatePicker.Date, SprintEndDatePicker.Date, SprintAssigneeNameEntry.Text, SprintAssigneePhoneEntry.Text, SprintAssigneeEmailEntry.Text, status, priority, SprintAlertsPicker.SelectedItem.ToString(), ViewProductPage.selectedProduct.Id, MainPage.activeUser.Id);
